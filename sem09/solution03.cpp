...
int main() {
    ...
    bool isValidIdentifier = !(containsInvalidSymbol(str) || isKeyword(str) || startsWithADigit(str));

	std::cout << std::boolalpha << isValidIdentifier << std::endl;
}
...
bool isKeyword(char* str) {
	return !strcmp(str, "auto") || !strcmp(str, "double")
