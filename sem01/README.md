...
Можем да разглеждаме различни видове променливи, както спрямо техния тип:
1. Булеви (bool)
...
3. Целочислени (short, int, long, ...)
   ...
   - long: [−263; 263 − 1], unsigned long: [0; 2^63 − 1]
4. Дробни (float, double, ...)

Така и спрямо областта на видимост:
...
Обща класификация на проемнливите:
...
### Декларация и инициализация на константа

const <тип> <идентификатор> = <израз>;

Стойността на константа трябва да бъде дадена при дефиниране и не може да се променя след това.
